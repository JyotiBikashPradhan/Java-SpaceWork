...
<body>
					...
					<nav>
						...
						<ul class="menu">
							...
							<li class="nav-item"><a class="nav-link"
								...
								<li class="nav-item"><a class="nav-link"
								href="view_users.jsp">View Users</a></li>
							<li class="nav-item"><a class="nav-link"
	...
	<center>
		<h1 style="color: white;" class="feedback">User's Details</h1>
	</center>
	<%
	try {
		Connection cn = D.getcon();
		PreparedStatement pres = cn.prepareStatement("select * from register_user");
