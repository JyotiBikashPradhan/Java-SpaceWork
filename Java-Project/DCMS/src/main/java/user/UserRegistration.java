...
public class UserRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps=cn.prepareStatement("INSERT INTO user_registration(username, name, password, address, gender, email)"+ "VALUES (?, ?, ?, ?, ?, ?)");
			...
			e.printStackTrace();
			out.println("<h5><center><font color='red'>Something Went Wrong !! Please Try Agaain.</font></center></h5>");
