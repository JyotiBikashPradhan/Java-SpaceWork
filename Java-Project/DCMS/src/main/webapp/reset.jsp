...
<%
	...
	try{
		...
		PreparedStatement ps=cn.prepareStatement("select email from user_registration where otp=?");
		ps.setString(1, otp);
		...
		if(rs.next())
		{
			...
			{
				PreparedStatement ps1=cn.prepareStatement("update user_registration set password=? where email=?");
