		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card mt-4">
					...
					<input type="hidden" class="form-control" name="slno" value="<%=rs.getInt(6) %>">
					...
					<div class="card-body">
						<form action="UserEdit" method="post">
							...
							<a href="userHomePage.jsp" class="btn btn-warning badge-pill btn-block">Back To Home Page</a>
							<a href="userLogout.jsp" class="btn btn-danger badge-pill btn-block">Logout</a>
						</form>
					</div>
				</div>
			</div>
