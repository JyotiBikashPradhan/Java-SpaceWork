...
%>
<h2 style="color: black;"><%=userid %> Apply For Death Certificate !!</h2>
<div class="aa">
	...
	<input type="text" name="dod" placeholder="Date Of Death" required />
	...
	<input type="text" name="reason" placeholder="Reason Of Death" required />
