		...
		<div class="form-36-mian section-gap">
			<div class="wrapper">
				<div class="form-inner-cont">
					...
					<form action="Reject" method="post" class="signin-form">
					
						<label for="story">Certificate Approved:</label>

						<textarea id="story"  name="reject" rows="15" cols="100">
						
						Dear <%=rs.getString(1) %> 
						Your <%=rs.getString(2) %> Certificate has been Reject By Administration
						 on the behalf of <%=rs.getString(3) %>
						 Thank You!!
						 Administrative</textarea>
						
						<% 
						String adminusername = (String) session.getAttribute("adminuname");
						%>
						
						<input type="hidden" name="remark" placeholder="Signature" value="<%=adminusername%>" required>
						...
						<div class="login-remember d-grid">
							...
							<button class="btn theme-button">Reject Certificare</button>
						</div>
					
					</form>
				
					<!-- <p class="signup">Don’t have an account? <a href="re.jsp" class="signuplink">Sign up</a></p> -->
					<p class="signup">Want to go Home Page?  <a href="adminHome.jsp" class="signuplink">Home Page</a></p>
				</div>
